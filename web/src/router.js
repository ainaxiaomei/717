      ...
      childRoutes: [
        {
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(app, require('./models/link/detail'))
              cb(null, require('./routes/link/detail'))
            }, 'link')
          },
        },{
          path: 'adv',
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(app, require('./models/adv/detail'))
              cb(null, require('./routes/adv/detail'))
            }, 'adv')
          },
        },{
          path: 'keyword',
          ...
          getComponent (nextState, cb) {
            require.ensure([], require => {
              registerModel(app, require('./models/keyword/detail'))
              cb(null, require('./routes/keyword/detail/'))
            }, 'keyword-detail')
          },
        },{
          path: 'user',
